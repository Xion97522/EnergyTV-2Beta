...
import { getHistory } from "@/data/watchlist";
        ...
        {continueWatching.length > 0 && (
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-3 px-4 md:px-6">
              ...
              <h2 className="text-xs font-black uppercase tracking-widest text-foreground/90" style={{ letterSpacing: "0.08em" }}>Continue Watching</h2>
            </div>
          ...
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-bold" style={{ color: "hsl(112,100%,54%)" }}>Add a TMDB API key to unlock live data</p>
                <p className="text-xs text-muted-foreground mt-0.5">Get a free key at themoviedb.org → add <code className="text-foreground/70 text-[11px]">VITE_TMDB_API_KEY</code> in Secrets</p>
              </div>
